...
export interface PartitionCompatibility {
    ...
    /** AWS ISO partition (aws-iso) compatibility status */
    readonly iso: PartitionStatus;
    /** AWS ISO-B partition (aws-iso-b) compatibility status */
    readonly isob: PartitionStatus;
}
