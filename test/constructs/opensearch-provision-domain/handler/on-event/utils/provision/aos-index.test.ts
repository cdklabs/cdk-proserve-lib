...
import { IndexProvisioner } from '../../../../../../../src/constructs/opensearch-provision-domain/handler/on-event/utils/provision/aos-index';
...
describe('OpenSearch Domain Index Provisioner', () => {
    ...
    describe('Update', () => {
        ...
        it('should be a no-operation when performed', async () => {
            // Arange
            config.allowDestructiveOperations = DestructiveOperation.ALL;

            const provisioner = new IndexProvisioner(config);
            const noopSpy = vi.spyOn(BaseProvisioner as any, noopMethodName);
    ...
    describe('Delete', () => {
        ...
        it('should delete the index when performed', async () => {
            // Arange
