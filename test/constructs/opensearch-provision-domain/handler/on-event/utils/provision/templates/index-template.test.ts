...
import { IndexTemplateProvisioner } from '../../../../../../../../src/constructs/opensearch-provision-domain/handler/on-event/utils/provision';
...
describe('OpenSearch Domain Index Template Provisioner', () => {
    ...
    describe('Create', () => {
        ...
        it('should create a index template when it does not already exist', async () => {
            // Arrange
            ...
            const provisioner = new IndexTemplateProvisioner(config);
        ...
        it('should skip creating a index template that already exists', async () => {
            // Arrange
            client.head?.mockReturnValueOnce(
                new Promise((resolve) =>
                    resolve({
        ...
        it('should throw an error in any other case', async () => {
            ...
            await expect(provisioner.run()).rejects.toThrow(
                'Unknown state of index template 1. Query returned 500'
            );
    ...
    describe('Delete', () => {
        ...
        describe('When performed', () => {
            ...
            it('should delete the index template when performed', async () => {
                // Arange
            ...
            it('should emit a warning message when the index template fails to delete', async () => {
                // Arange
                ...
                expect(warnSpy).toHaveBeenCalledExactlyOnceWith(
                    'Failed to delete index template 1'
                );
            });
        });
    });
